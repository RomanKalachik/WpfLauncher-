...
namespace DotNext.Native {
	...
	public sealed class Job : IDisposable {
		...
		public void SetCpuLimit(int percent, bool hardCap = true) {
			...
			if (!NativeMethods.SetInformationJobObject(_handle, JobInformationClass.CpuRateControlInformation, info, Marshal.SizeOf(typeof(JobCpuRateControlInformation))))
				throw new Win32Exception();
		}
